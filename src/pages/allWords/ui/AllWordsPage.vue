  ...
  <div class="h-full overflow-auto">
    ...
    <div v-else class="mx-auto max-w-3xl space-y-4 p-6">
      <header class="flex items-start justify-between gap-3">
        ...
        <PageInfo
          title="Все слова"
          description="Полный список слов из Google Doc. Переключатель «Все / Выученные / Невыученные» фильтрует по статусу (секции ## learned / ## new в доке). Поиск ищет по слову, переводу и фразе."
        />
      </header>
