...
<template>
  ...
  <div v-else class="flex h-full flex-col">
    <div class="flex items-center gap-2 border-b border-slate-800 px-4 py-2">
      ...
      <PageInfo
        title="Карточки"
        description="Флешкарты текущей колоды. Тап по карточке — перевернуть. Свайп вправо — знаю, влево — не знаю (или кнопки ✓/✗ внизу). Новые слова закрываются после 5 ✓ подряд, повторы — после 3. В режиме «Свободное повторение» — всегда 5 ✓. Стрелки ‹/› листают без отметки."
      />
    </div>
    <DeckSelector />
